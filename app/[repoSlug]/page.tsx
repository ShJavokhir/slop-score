...
import { TubeNav, TubeNavItem } from '../components/ui/TubeNav';
...
export default function RepoDetailPage() {
  ...
  const tabs: TubeNavItem[] = [
    { id: 'overview', label: 'Overview' },
    { id: 'ai-slop', label: 'Features' },
    { id: 'hardcode', label: 'Hardcoded' },
    { id: 'readme', label: 'AI Slop' },
  ];
      ...
      <div className="mb-16">
        <div className="flex items-start justify-between mb-8">
          <div className="flex-1">
            ...
            <div className="flex items-center gap-5 text-gray-600 flex-wrap">
              <a
                href={analysis.githubUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-600 hover:text-blue-700 font-medium text-sm flex items-center gap-1.5 transition-colors"
              >
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-sm font-medium">{analysis.stars.toLocaleString()}</span>
              </div>
